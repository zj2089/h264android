...
typedef int32 (*FunctionType_DPBAlloc)(void *userData, uint frame_size_in_mbs, uint num_buffers);
...
/** @brief AVC library calls this function is reserve a memory of one frame from the DPB.
	...
	*/
typedef int32 (*FunctionType_FrameBind)(void *userData, int32 indx, uint8 **yuv);
...
/** @brief AVC library calls this function once a bound frame is not needed for decoding
	...
	@return  none.
*/
typedef void (*FuctionType_FrameUnbind)(void *userData, int32 indx);
...
*/
typedef	int32 (*FunctionType_Malloc)(void *userData, int32 size, int32 attribute);

/** Function pointer to free
\param "mem" "Pointer to the memory to be freed casted to int"
\return "void"
*/
typedef	void (*FunctionType_Free)(void *userData, int32 mem);
